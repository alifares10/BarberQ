...
export default function ShopOwnerTabsLayout() {
  ...
  return (
    ...
    >
      ...
      <Tabs.Screen
        name="calendar"
        options={{ title: t('tabs.calendar'), tabBarIcon: tabIcon('cal') }}
      />
      <Tabs.Screen
        name="shop"
        options={{ title: t('tabs.shop'), tabBarIcon: tabIcon('settings') }}
      />
      <Tabs.Screen
        name="barbers"
        options={{ title: t('tabs.barbers'), tabBarIcon: tabIcon('scissors') }}
      />
      <Tabs.Screen
        name="profile"
